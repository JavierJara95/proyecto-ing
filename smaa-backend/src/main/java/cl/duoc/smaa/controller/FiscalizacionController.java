...
public class FiscalizacionController {
    ...
    @GetMapping("/folio/{folio}") public DeclaracionViaje porFolio(@PathVariable String folio) { return service.buscarPorFolio(folio); }
    @GetMapping("/qr/{codigoQr}") public DeclaracionViaje porQr(@PathVariable String codigoQr) { return service.buscarPorQr(codigoQr); }
    @GetMapping("/patente/{patente}") public DeclaracionViaje porPatente(@PathVariable String patente) { return service.buscarPorPatente(patente); }
